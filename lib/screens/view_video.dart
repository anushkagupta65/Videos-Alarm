...
//     // Fetch video data from Firestore if not provided
//     _fetchVideoData();
//     videoController.fetchSameCategoryVideos(category ?? '');
//     videoController.checkUserActiveStatus();
//     _fetchVideoAds();
...
//     if (videoLink != null && videoTitle != null && description != null) return;
...
//           .get();
//       if (doc.exists) {
//         videoLink = doc.data()?['videoUrl'] as String?;
//         videoTitle = doc.data()?['title'] as String?;
...
//       Get.snackbar('Error', 'Failed to load video data');
//     }
//   }
...
//   Future<void> _incrementViewCount() async {
//     if (viewCountUpdated.value || videoId == null) return;
