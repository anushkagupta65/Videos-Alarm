...
class SubscriptionPlanCard extends StatefulWidget {
  ...
  SubscriptionPlanCard(
      {Key? key, required this.planId, required this.onSubscribe})
      : super(key: key);
                ...
                child: Column(
                  ...
                  children: [
                    AnimatedOpacity(
                      ...
                      child: Center(
                        child: Text(
                          '${_price != 'Error' && _price != 'Loading...' ? _price : (_price == 'Loading...' ? 'Loading...' : 'Unavailable')}/Only',
                          style: TextStyle(
                            fontSize: 20.sp,
                            color: Colors.grey[400],
                            fontWeight: FontWeight.w600,
                    ...
                    AnimatedOpacity(
                      ...
                      child: Center(
                        child: Text(
                          _description == 'Loading...'
                              ? 'Loading description...'
                              : _description ?? 'Unavailable description',
                          style: TextStyle(
                            fontSize: 16.sp,
                            color: Colors.grey[600],
                            height: 1.4,
