...
import 'package:google_fonts/google_fonts.dart';
import 'package:videos_alarm_app/screens/Vid_controller.dart';
import 'package:videos_alarm_app/screens/live_videos.dart'; // Contains VideoItem model
import 'package:youtube_player_flutter/youtube_player_flutter.dart';

class VideoPlayerPage extends StatefulWidget {
  final VideoItem video;
  final bool isLive; // <-- 1. ADD THIS to receive the live status

  const VideoPlayerPage({
    Key? key,
    required this.video,
    required this.isLive, // <-- 2. UPDATE the constructor
  }) : super(key: key);
  ...
  void initState() {
    ...
    _controller = YoutubePlayerController(
      ...
      flags: YoutubePlayerFlags(
        mute: false,
        autoPlay: true, // Auto-play when entering the screen
        disableDragSeek: false,
        loop: false,
        isLive: widget.isLive, // <-- 3. USE THE DYNAMIC isLive FLAG HERE
        forceHD: false,
        enableCaption: true,
      ),
    )..addListener(_onPlayerStateChange);
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                const SizedBox(width: 4),
                                Text(
                                  // <-- 4. THE MAIN CHANGE! Use the dynamic view count.
                                  widget.video.dynamicViewCount,
                                  style: GoogleFonts.roboto(
